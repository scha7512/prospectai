...
export interface CRMEntry {
  business: Business;
  status: "nouveau" | "contacte" | "interesse" | "signe" | "pas_interesse" | "nrp" | "faux_lead" | "faux_num" | "ferme" | "deja_installe" | "email_envoye";
  note: string;
...
export function updateCRMEntry(placeId: string, patch: Partial<Pick<CRMEntry, "status" | "note" | "rappelAt" | "rappelDirection" | "siteCree">>) {
  const crm = getCRM();
